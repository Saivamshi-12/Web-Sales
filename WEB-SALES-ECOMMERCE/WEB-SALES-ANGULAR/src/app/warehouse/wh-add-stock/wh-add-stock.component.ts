...
export class WhAddStockComponent implements OnInit {
  ...
  addStockURL : string = 'https://localhost:44366/api/Warehouse/addStock';
  addStockQtyUrl : string = 'https://localhost:44366/api/Warehouse/addStockQty';
  getQtyUrl : string = 'https://localhost:44366/api/Warehouse/getqty';
  updateStockUrl : string = 'https://localhost:44366/api/Warehouse/updateStock';
  updateStockQtyUrl :string = 'https://localhost:44366/api/Warehouse/updateStockQty';
